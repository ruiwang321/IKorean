...
- (void)getAd {
    ...
    [_adView loadAdWithAdUnitId:self.networkConfig.pubId2 AppId:self.networkConfig.pubId IsAutoRequest:NO]; // 开始加载广告@"818260D7ACAE742A194F0BBE9EDBCF93"@"5714887afc897826"
